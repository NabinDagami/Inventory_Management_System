...
class DataImportValidator:
    ...
    def _validate_sheet(self, excel_file: pd.ExcelFile, sheet_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Check for critical required fields (lenient validation)
            ...
            # Lenient: allow partial data
            pass  # Allow sheets with missing fields
            ...
            # Do not fail on field errors for import
            pass  # Allow import even with some field issues
            ...
            # Allow sheets with errors to be imported
            pass
